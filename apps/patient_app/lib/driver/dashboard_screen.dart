...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  if (dash.driver != null && !dash.driver!.isVerified)
                    _VerificationBanner(),
                  _StatusCard(dash),
  ...
  Future<void> _accept(String rideId) async {
    final result = await ref.read(dashboardProvider.notifier).acceptRide(rideId);
    if (!mounted) return;
...
class _VerificationBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: const EdgeInsets.only(bottom: core.kSpaceLG),
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Account pending verification. You cannot go online until an admin verifies your profile.',
          ...
          children: [
            ...
            Semantics(
              ...
              child: Switch.adaptive(
                ...
                onChanged: (dash.driver?.isVerified ?? false)
                    ? (_) => ref.read(dashboardProvider.notifier).toggleOnline()
                    : null,
              ),
            ),
          ],
